...
import com.yuzhai.slidingmenu.SlidingMenu.OnClosedListener;
import com.yuzhai.slidingmenu.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
    ...
    public interface OnPageChangeListener {
        ...
        /**
         * 当前页面滚动或一部分以编程方式启动平滑滚动或用户发起的触摸滚动时将调用此方法
         *
