...
public class OrderAcceptedDetailFragment extends Fragment {
    ...
    public static OrderAcceptedDetailFragment newInstance(String order) {
     ...
     * @param detailOrder
     */
    public void updateData(final OrderAcceptedDetailBean.OrderInfoBean detailOrder) {
        //设置订单号
     ...
     * @param imageList
     */
    private void setFlipperImages(List<OrderAcceptedDetailBean.OrderInfoBean.PicturesBean> imageList) {
