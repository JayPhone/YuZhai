...
public class ForgetPswActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private UserForgetPswBean mUserForget;
    ...
    public void initViews() {
        ...
        mUserPhoneEdit = (EditText) findViewById(R.id.user_name);
        mCheckCodeEdit = (EditText) findViewById(R.id.verify_code);
        mCheckCodeButton = (Button) findViewById(R.id.verify_button);
    ...
    public void sendVerifyRequest(String forgetPswPhone) {
        if (checkForgetPswPhone(forgetPswPhone)) {
            //生成获取验证码请求参数
            Map<String, String> params = ParamsGenerateUtil.generateVerifyParams(mUserPhoneBean.getUserPhone(),
                    mCustomApplication.getToken());
    ...
    public boolean checkForgetPswData(String userPhoneText,
        ...
        mUserForget = new UserForgetPswBean(userPhoneText, checkCodeText, pswText);
        return true;
    }
}
