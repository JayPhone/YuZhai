 ...
 * @author smile
 */
public abstract class ContactConversationBean implements Serializable, Comparable {
    ...
    public boolean equals(Object o) {
        ...
        ContactConversationBean that = (ContactConversationBean) o;
    ...
    public int compareTo(Object another) {
        if (another instanceof ContactConversationBean) {
            ContactConversationBean anotherConversation = (ContactConversationBean) another;
